...
class TestIds:
    ...
    BANNER = "ca-app-pub-8683804969734679/8151169409"
...
class AndroidBridge(AdMobBridge):
    ...
    def new_banner(self, unitID, top_pos=True):
        ...
        self._adview.setAdSize(AdSize(320,50))
...
class KivMob:
    ...
    def load_rewarded_is_success(self):
        if self.bridge.rewardedAdLoadCallback4kivy.mRewardedAd!=None:
            return True
        else:
            return False
    def show_rewarded_ad(self):
